...
- [ ] `T103` Register the swe_factory_resolve_overlap tool passing session projectId and acknowledgedSecretRisk — agent, complexity: simple, depends-on: T99, design: docs/designs/2026-09-10-agent-driven-lesson-supersession.md
