...
- [ ] `T104` Add the CLI maintenance command printing the lesson maintenance digest sections — agent, complexity: simple, design: docs/designs/2026-09-10-agent-driven-lesson-supersession.md
