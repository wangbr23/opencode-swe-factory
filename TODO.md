...
- [ ] `T100` Render approval-card overlap evidence (bounded body preview with delimiters, Supersede option only for same-scope same-project targets, `related` rendering for semantic-only hits) — agent, complexity: simple, depends-on: T101, design: docs/designs/2026-09-10-agent-driven-lesson-supersession.md
