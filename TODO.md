...
- [ ] `T101` Augment lesson duplicate detection with an async semantic pass producing a `related` relation with its own cutoff constant, failing open to lexical-only — agent, complexity: complex, design: docs/designs/2026-09-10-agent-driven-lesson-supersession.md
