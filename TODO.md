...
- [ ] `T102` Wire the injectable lesson embedding indexer into the adapter (schedule after commit/resolution and at session start, fail-open) — agent, complexity: simple, design: docs/designs/2026-09-10-agent-driven-lesson-supersession.md
